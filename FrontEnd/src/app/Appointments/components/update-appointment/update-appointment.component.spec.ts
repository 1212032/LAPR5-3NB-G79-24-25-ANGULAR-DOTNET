...
describe('UpdateAppointmentComponent', () => {
    ...
    beforeEach(async () => {
        ...
        appointmentService = jasmine.createSpyObj('AppointmentService', ['getAppointmentById', 'updateAppointment']);
    ...
    it('should fetch appointment on ngOnInit', async () => {
        expect(component.appointmentId).toBe(1);
    ...
    it('should create appointment dto', () => {
        ...
        const dto: UpdatingAppointmentDto = component.createDTO();
        ...
        staffIds3.push('1');
        const expected: UpdatingAppointmentDto = {
            id: 1,
    ...
    it('should show success message when appointment is updated successfully', () => {
        ...
        appointmentService.updateAppointment.and.returnValue(of(appointmentDto));
        component.updateAppointment();
        expect(toastrService.success).toHaveBeenCalledWith('Appointment updated successfully', 'Success');
    });

    it('should show error message when updating fails', () => {
        appointmentService.updateAppointment.and.returnValue(throwError({ error: { message: 'Error message' } }));
        component.updateAppointment();
        expect(toastrService.error).toHaveBeenCalledWith('Failed to update appointment\nError message', 'Error');
    });
});