...
% lista de staff (codigo,tipo,especializacao,lista de tipos de cirurgias)
...
availability_operation(OpCode,Room,Day,LPossibilities,LDoctors):-
	...
	% busca o tempo da operacao atraves do tipo
	surgery(OpType,_,TSurgery,_),
	% constroi uma lista dos medicos necessarios para a operacao
    findall(Doctor,assignment_surgery(OpCode,Doctor),LDoctors),
	% interseta as agendas dos medicos para o dia -> LA
